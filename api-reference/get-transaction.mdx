...
api: "GET https://api.cngn.co/v1/api/transaction/{tnxRef}"
...
```bash cURL
curl -X GET "https://api.cngn.co/v1/api/transaction/WD-7f3a2b1c" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```typescript TypeScript
const res = await fetch(
  `https://api.cngn.co/v1/api/transaction/${trxRef}`,
...
```python Python
res = requests.get(
    f"https://api.cngn.co/v1/api/transaction/{trx_ref}",
